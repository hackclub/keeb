...
We recommend that you use **RMK**, since it's modern and easy to use. [Here](https://rmk.rs/docs/user_guide/guide_overview.html) is a tutorial for getting started with RMK.
...
Want to add extra features to your keyboard? Check out [Adding Extra Parts](/docs/adding-parts).
