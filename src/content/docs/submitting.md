...
- **README.md**: writeup of your project covering what you built, why, and what you learned
- **PCB files**: `.kicad_pcb`, `.kicad_sch`, and a zipped folder of Gerbers + drill files
- **bom.csv**: your bill of materials, the parts you bought with the grant, saved as a CSV file
- **Case files**: STEP export of your case from Onshape
- **Photos**: progress shots taken throughout the build (every 1 to 4 hours) and your finished keyboard
